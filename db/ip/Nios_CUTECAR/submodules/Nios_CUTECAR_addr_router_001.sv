...
(
    ...
    localparam PAD16 = log2ceil(64'h2000 - 64'h1000); 
    localparam PAD17 = log2ceil(64'h3000 - 64'h2800); 
    localparam PAD18 = log2ceil(64'h3010 - 64'h3000); 
    localparam PAD19 = log2ceil(64'h3020 - 64'h3010); 
    localparam PAD20 = log2ceil(64'h3028 - 64'h3020); 
    localparam PAD21 = log2ceil(64'h6000000 - 64'h4000000); 
    // -------------------------------------------------------
    ...
    // ( 0x90 .. 0xa0 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 27'h90   ) begin
            src_channel = 22'b0000000010000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 16;
    end

    // ( 0xa0 .. 0xb0 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 27'ha0   ) begin
            src_channel = 22'b0100000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 7;
    end

    // ( 0x100 .. 0x110 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 27'h100   ) begin
            src_channel = 22'b0000001000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 19;
    end

    // ( 0x110 .. 0x120 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 27'h110   ) begin
            src_channel = 22'b0000010000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 4;
    end

    // ( 0x120 .. 0x130 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 27'h120   ) begin
            src_channel = 22'b0000100000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 9;
    end

    // ( 0x130 .. 0x140 )
    if ( {address[RG:PAD14],{PAD14{1'b0}}} == 27'h130   ) begin
            src_channel = 22'b0001000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x140 .. 0x150 )
    if ( {address[RG:PAD15],{PAD15{1'b0}}} == 27'h140   ) begin
            src_channel = 22'b0010000000000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 8;
    end

    // ( 0x1000 .. 0x2000 )
    if ( {address[RG:PAD16],{PAD16{1'b0}}} == 27'h1000   ) begin
            src_channel = 22'b0000000000000000000010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 5;
    end

    // ( 0x2800 .. 0x3000 )
    if ( {address[RG:PAD17],{PAD17{1'b0}}} == 27'h2800   ) begin
            src_channel = 22'b0000000000000000000001;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 3;
    end

    // ( 0x3000 .. 0x3010 )
    if ( {address[RG:PAD18],{PAD18{1'b0}}} == 27'h3000   ) begin
            src_channel = 22'b0000000000000000100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 18;
    end

    // ( 0x3010 .. 0x3020 )
    if ( {address[RG:PAD19],{PAD19{1'b0}}} == 27'h3010   ) begin
            src_channel = 22'b0000000000000000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 0;
    end

    // ( 0x3020 .. 0x3028 )
    if ( {address[RG:PAD20],{PAD20{1'b0}}} == 27'h3020   ) begin
            src_channel = 22'b0000000000000000001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
    end

    // ( 0x4000000 .. 0x6000000 )
    if ( {address[RG:PAD21],{PAD21{1'b0}}} == 27'h4000000   ) begin
